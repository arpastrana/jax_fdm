...
# ==========================================================================
    ...
    ) -> tuple[Float[Array, "edges"], Float[Array, "supports 3"], Float[Array, "nodes 3"]]:
        """
...
# ==========================================================================
    ...
    def mask_fdm(
        ...
        """
        Returns an iterator over boolean masks for the force density, xyz fixed, and loads parameters.
        """
