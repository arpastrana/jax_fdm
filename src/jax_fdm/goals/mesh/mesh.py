...
class MeshGoal(Goal):
    ...
    passable-but-ignored argument, and the whole mesh-goal family constructs from
    a target and a weight alone.
    """
    ...
    def index(
        ...
        -------
        index :
            The sentinel index ``-1``, since the goal spans the whole mesh and
        ...
        returning the sentinel unchanged. Every mesh-goal prediction reads the
