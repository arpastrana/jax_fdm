...
- Added how-to guides on writing custom goals (`docs/howto/goals.md`) and constraints (`docs/howto/constraints.md`) under a new How-to Guides section, and split the examples page into an Examples section (`docs/examples/arch.md` walkthrough plus `docs/examples/more.md` galleries) with a redirect from the old `examples/` URL.
