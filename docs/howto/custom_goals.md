...
(Constraints get the same treatment in [custom constraints](custom_constraints.md).)
...
- `index` is the integer row your edge key was resolved to when the goal was initialized: the row of *one* edge inside those arrays.
