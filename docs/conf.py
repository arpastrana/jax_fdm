...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith('jax_fdm'):
        return None
    ...
    return f"https://github.com//jax_fdm/blob/master/src/{filename}.py#L{lineno}"
...
html_theme_options = {
    "package_name"    : "jax_fdm",
    "package_title"   : project,
    "package_version" : release,
    "package_author"  : "Rafael Pastrana",
    "package_docs"    : "https://.github.io/jax_fdm/",
    "package_repo"    : "https://github.com//jax_fdm",
    "package_old_versions_txt": "https://.github.io/jax_fdm/doc_versions.txt"
}
