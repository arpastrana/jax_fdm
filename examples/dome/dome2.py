...
num_sides = 16
num_rings = 8
offset_distance = 0.01  # ring offset in 2D
...
optimizer = LBFGSB
maxiter = 10000
tol = 1e-14  # 1e-6 for best results at the cost of a considerable speed decrease
...
loss = Loss(
            SquaredError(goals=goals_length),
...
if view:
    ...
    mesh = Mesh.from_lines([c_network.edge_coordinates(*edge) for edge in c_network.edges()],
