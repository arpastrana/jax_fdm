...
def register_fd_scene_objects():
    ...
    or :class:`jax_fdm.datastructures.FDMesh` through the jax_fdm artists.
    ...
    if has_backend("compas_notebook"):
        from jax_fdm.visualization.notebooks.scene import register_notebook_scene_objects
        register_notebook_scene_objects()

    if has_backend("compas_viewer"):
        from jax_fdm.visualization.viewers.scene import register_viewer_scene_objects
