...
- Added a documentation guide on writing custom goals and constraints (`docs/custom_goals.md`), with recipes for scalar, vector and aggregate goals plus custom constraints.
